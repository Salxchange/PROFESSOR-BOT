...
PICS = (environ.get('PICS' ,'https://telegra.ph/file/c73d0dc576c2a933e0d21.jpg https://telegra.ph/file/f8cea12edd7df38e8f4ec.jpg https://telegra.ph/file/59342bfdf656d3129725f.jpg')).split()
UPTIME = time.time()

# Admins, Channels & Users
CACHE_TIME = int(environ.get('CACHE_TIME', 300))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1966867320').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001796376730').split()]
