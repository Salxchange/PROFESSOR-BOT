...
I Cᴀɴ Pʀᴏᴠɪᴅᴇ Movies 🍿 Fᴏʀ Yᴏᴜ Jᴜsᴛ Aᴅᴅ Mᴇ Iɴ Yᴏᴜʀ Gʀᴏᴜᴘ Oʀ Jᴏɪɴ Oᴜʀ Gʀᴏᴜᴘ</b>"""
    
    HELP_TXT = "Hᴇʏ {}\nHᴇʀᴇ Mꜱ Mʏ Hᴇʟᴩ"

    ABOUT_TXT = """- 𝖢𝗋𝖾𝖺𝗍𝗈𝗋 : <a href="https://telegram.me/MysteryDemon">𝖬𝗒𝗌𝗍𝖾𝗋𝗒𝖣𝖾𝗆𝗈𝗇</a>
- 𝖫𝗂𝖻𝗋𝖺𝗋𝗒 : Pyrogram
- 𝖫𝖺𝗇𝗀𝗎𝖺𝗀𝖾 : 𝖯𝗒𝗍𝗁𝗈𝗇 𝟥
- 𝖣𝖺𝗍𝖺𝖡𝖺𝗌𝖾 : 𝖬𝗈𝗇𝗀𝗈𝖣𝖡
- 𝖡𝖮𝖳 𝖲𝖾𝗋𝗏𝖾𝗋 : 𝖠𝗇𝗒𝖶𝗁𝖾𝗋𝖾
- 𝖡𝗎𝗂𝗅𝖽 𝖵𝖾𝗋𝗌𝗂𝗈𝗇 : 𝖯𝗋𝗈𝗃𝖾𝖼𝗍 𝖴𝗉𝗁𝗈𝗋𝗂𝖺 𝖵2.O﹝ʙᴇᴛᴀ﹞
 """
